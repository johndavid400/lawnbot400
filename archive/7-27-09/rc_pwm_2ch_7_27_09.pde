...
// digital pins 4,5,6, & 7 control motor1, digital pins 8, 9, 10, & 11 control motor2. DP 12 and 13 are neutral indicator lights. DP 2 and 3 are inputs from the R/C receiver. All analog pins are open. "enable1_a" and "motor1_a" are opposite legs of the H-bridge. When a high-side mosfet is brought HIGH, it is ON (LOW = OFF). Low side mosfets: LOW = ON (HIGH = OFF). Low side mosfets should be driven via PWM, and High side mosfets act as switches.
