...
void rc1()
{
  ...
  else
  {
    ...
    //void unwanted signals
    //if ((RCval1 - rcval_prev) > 500){
    //  
    //  }
...
///////// MOTOR2 /////////
  ...
  if (adj_val2 > 260) {  
    //Forward
    analogWrite(motor2_a, adj_val2 - 260); //write adj_val1 to motor1
    ...
    analogWrite(motor2_b, 250 - adj_val2); //write adj_val1 to motor1
    digitalWrite(ledPin2, LOW);
  }
  else {
  //STOP
